...
| `maplibre`      | MapLibre GL JS        | 6.9.1   | [MapLibre GL JS](https://github.com/maplibre/maplibre-gl-js)              |
...
### MapLibre GL JS 6.9.1

- [maplibre-gl.mjs](https://cdn.jsdelivr.net/npm/maplibre-gl@6.9.1/dist/maplibre-gl.mjs) - main vector map renderer module.
- [maplibre-gl-shared.mjs](https://cdn.jsdelivr.net/npm/maplibre-gl@6.9.1/dist/maplibre-gl-shared.mjs) - code shared between the main module and the worker.
- [maplibre-gl-worker.mjs](https://cdn.jsdelivr.net/npm/maplibre-gl@6.9.1/dist/maplibre-gl-worker.mjs) - map data processing off the main thread.
- [maplibre-gl.css](https://cdn.jsdelivr.net/npm/maplibre-gl@6.9.1/dist/maplibre-gl.css) - MapLibre map and control styles.
- [maplibre-gl.mjs.map](https://cdn.jsdelivr.net/npm/maplibre-gl@6.9.1/dist/maplibre-gl.mjs.map) - source map for the main module.
- [maplibre-gl-shared.mjs.map](https://cdn.jsdelivr.net/npm/maplibre-gl@6.9.1/dist/maplibre-gl-shared.mjs.map) - source map for the shared code.
- [maplibre-gl-worker.mjs.map](https://cdn.jsdelivr.net/npm/maplibre-gl@6.9.1/dist/maplibre-gl-worker.mjs.map) - source map for the worker.
